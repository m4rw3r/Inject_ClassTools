...
/**
 * Creates a preload file which contains multiple classes which have been stripped
 * of comments and whitespace.
 */
class PreloadFileCompiler
{
	/**
	...
	/**
	 * Returns the PHP code which is to be written to the preload file, does not
	 * include PHP start tag.
	 * 
	 * @return string
	 */
...
/* End of file PreloadFileCompiler.php */
